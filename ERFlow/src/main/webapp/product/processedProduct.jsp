...
<%
final String PROGRAM_CODE = "5C5D1BE8247DEADA5D073A263A19B4E02240BB7A6D2E8087723AEA0783B68C0C";
	...
	<div class="wrap">
		...
		<div class="content-wrap">
			...
			<div class="right-align">
				<span class="menu-name">사용자 > 구매 > 가공품 관리</span>
			</div>

			<form action="productDeleteProc.jsp" method="post" name="productFrm">
			<input type="hidden" name = "type" value="processed">
				<div class="table-header-container">
					<div class="button-group">
						<button type="button" class="btn btn-danger" id="delete-button" value="delete">삭제</button>
						<button type="button" class="btn btn-primary" id="register-button" data-value="processed">추가</button>
						</button>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						int totalRecord = productCon.getProductCount(keyfield, keyword, "processed");
						...
						Vector<ProductBean> products = productCon.getProducts(keyfield, keyword, start, numPerPage, "processed");
						// 가공품 정보 출력
						...
						<tr>
							...
							<td><a href="productUpdate.jsp?flag=processed&id=<%=id%>"><%=id%></a></td>
							<td><%=name%></td>
							<td><%=count%></td>
							<td>가공품</td>
						</tr>
