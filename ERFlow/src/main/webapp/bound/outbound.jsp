...
<%
final String PROGRAM_CODE = "E36738BC1F02168BCAFEE6EA48494ADBC077E402ECD1BAE980DEC1FB5E8144B7";
	...
	<div class="wrap">
		...
		<div class="content-wrap">
			...
			<div class="right-align">
				<span class="menu-name">사용자 > 영업 > 출고 제품 관리</span>
			</div>

			<form action="boundDeleteProc.jsp" method="post" name="boundFrm">
				<input type="hidden" name="flag" value="outbound">
				<div class="table-header-container">
					<div class="button-group">
						<button type="button" class="btn btn-danger" id="delete-button" name="outbound" value="delete">삭제</button>
						<button type="button" class="btn btn-primary" id="register-button" data-value="outbound">추가</button>
					</div>
					<div class="search-option">
						<select name="keyfield" id="">
							...
							<option value="userName" <%=keyfield.equals("userName") ? "selected" : ""%>>출고자</option>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						int totalRecord = boundCon.getBoundCount(keyfield, keyword, 1);
						...
						Vector<ViewBoundBean> bounds = boundCon.getBounds(keyfield, keyword, start, numPerPage, 1);
						...
						<tr>
							...
							<td><a href="boundUpdate.jsp?id=<%=id%>&flag=outbound&productName=<%=productName %>&userName=<%=userName%>"><%=id%></a></td>
							<td><%=productName%></td>
							<td><%=userName%></td>
							<td><%=address%></td>
							<td><%=boundedAt%></td>
