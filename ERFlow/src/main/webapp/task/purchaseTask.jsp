...
<%
final String PROGRAM_CODE = "3879BC2C91F0F2F88E7468299B546E2F2098B09186750212D2247F73306B0A79";
		...
		<div class="content-wrap">
			...
			<div class="table-wrap">
				<div class="right-align">
					<span class="menu-name">사용자 > 구매 > 발주 관리</span>
				</div>

				<form action="taskDeleteProc.jsp" method="post" name="taskFrm">
					<input type="hidden" name="flag" value="purchase">
					<div class="table-header-container">
						<div class="button-group">
							<button type="button" class="btn btn-danger" id="delete-button"
								name="purchase" value="delete">삭제</button>
							<button type="button" class="btn btn-primary"
								id="register-button" data-value="purchase">추가</button>
						</div>
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							int totalRecord = taskCon.getTaskCount(keyfield, keyword, 1);
							...
							Vector<ViewTaskBean> tasks = taskCon.getTasks(keyfield, keyword, start, numPerPage, 1);
							...
							<tr>
								<th scope="col"><input type="checkbox" name="taskId"
									value="<%=id%>"></th>
								<td><a
									href="taskUpdate.jsp?id=<%=id%>&flag=purchase&userName=<%=userName%>&companyName=<%=companyName%>"><%=id%></a></td>
								<td><%=userName%></td>
								<td><%=deptName%></td>
								<td><%=companyName%></td>
								<td><%=subject%></td>
