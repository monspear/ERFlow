...
<script src="js/main/findEachUser.js"></script>
</head>
<body>
		...
		<div class="search-message-body">
			<div class="search-select-option-wrap">
				<div class="search-select-option">
					<form method="get" action="" name="searchFrm">
						...
						<select class="search-people-dept" name="deptKeyfield">
							...
							%>
							<option value="<%=name%>"
								<%=deptKeyfield.equals(name) ? "selected" : ""%>><%=name%></option>
							<%
							}
							%>
						</select> <select class="search-people-job" name="jobKeyfield">
							...
							%>
							<option value="<%=name%>"
								<%=jobKeyfield.equals(name) ? "selected" : ""%>><%=name%></option>
							<%
							}
							%>
				...
				<form method="post" name="search-people-body" id="selectFrm">
					...
					<div class="search-button">
						<button class="btn btn-primary" type="button" id="select-button">선택</button>
					</div>
			</div>
			...
			<table class="search-people-body table">
				...
				<tbody>
					...
					%>
					<tr>
						<td class="search-people-body-check"><input name="userId"
